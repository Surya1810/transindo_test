...
// Allow the constructor to pass in JSZip and  from external requires.
...
//
// PDF export - using  - http://.org
//
DataTable.ext.buttons.pdfHtml5 = {
	className: 'buttons-pdf buttons-html5',

	available: function () {
		return window.FileReader !== undefined && _();
	},
